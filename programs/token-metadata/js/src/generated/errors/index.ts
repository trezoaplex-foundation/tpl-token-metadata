 ...
 * @category generated
 */
export class ReservationNotCotpleteError extends Error {
  readonly code: number = 0x41;
  readonly name: string = 'ReservationNotCotplete';
  constructor() {
    super('');
    if (typeof Error.captureStackTrace === 'function') {
      Error.captureStackTrace(this, ReservationNotCotpleteError);
    }
  }
}

createErrorFromCodeLookup.set(0x41, () => new ReservationNotCotpleteError());
createErrorFromNameLookup.set('ReservationNotCotplete', () => new ReservationNotCotpleteError());
...
export class MissingSplTokenProgramError extends Error {
  ...
  constructor() {
    super('Missing TPL token program');
    if (typeof Error.captureStackTrace === 'function') {
