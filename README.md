...
### TypeScript
```sh
npm install @trezoaplex-foundation/tpl-token-metadata
```

[See typedoc documentation](https://tpl-token-metadata-js-docs.vercel.app/).

### Rust
```sh
cargo add tpl-token-metadata
```

[See crate documentation](https://docs.rs/tpl-token-metadata/latest/tpl_token_metadata/).
...
This will start a local validator using [Amman](https://github.com/trezoaplex-foundation/amman).
...
Full documentation for Token Metadata can be found here [developers.trezoaplex.com/token-metadata](https://developers.trezoaplex.com/token-metadata). 

## Security

To report a security issue, please follow the guidance on our [bug bounty program](https://www.trezoaplex.com/bounty-program) page.

## License

The Rust/Cargo programs are licensed under the
"Apache-style" [Trezoaplex(TM) NFT Open Source License](https://github.com/trezoaplex-foundation/tpl-token-metadata/blob/master/LICENSE) and the JS/TS client libraries are licensed
