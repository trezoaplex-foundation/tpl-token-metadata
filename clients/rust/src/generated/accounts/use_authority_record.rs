...
itpl UseAuthorityRecord {
    ...
    pub fn find_pda(mint: &Pubkey, use_authority: &Pubkey) -> (trezoa_program::pubkey::Pubkey, u8) {
...
itpl<'a> TryFrom<&trezoa_program::account_info::AccountInfo<'a>> for UseAuthorityRecord {
