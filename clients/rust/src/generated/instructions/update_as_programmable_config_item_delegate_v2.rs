...
itpl UpdateAsProgrammableConfigItemDelegateV2 {
    pub fn instruction(
        &self,
...
itpl UpdateAsProgrammableConfigItemDelegateV2InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: 50,
...
itpl UpdateAsProgrammableConfigItemDelegateV2Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Update authority or delegate
...
itpl<'a, 'b> UpdateAsProgrammableConfigItemDelegateV2Cpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> UpdateAsProgrammableConfigItemDelegateV2CpiBuilder<'a, 'b> {
