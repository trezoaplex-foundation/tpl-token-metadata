...
pub struct SetAndVerifySizedCollectionItem {
    ...
    pub collection_authority: trezoa_program::pubkey::Pubkey,
    /// payer
    ...
    pub collection_mint: trezoa_program::pubkey::Pubkey,
    /// Metadata Account of the Collection
    pub collection: trezoa_program::pubkey::Pubkey,
    /// MasterEdition2 Account of the Collection Token
    pub collection_master_edition_account: trezoa_program::pubkey::Pubkey,
    /// Collection Authority Record PDA
    pub collection_authority_record: Option<trezoa_program::pubkey::Pubkey>,
}

itpl SetAndVerifySizedCollectionItem {
...
itpl SetAndVerifySizedCollectionItemInstructionData {
    pub fn new() -> Self {
...
pub struct SetAndVerifySizedCollectionItemBuilder {
    ...
    collection_authority: Option<trezoa_program::pubkey::Pubkey>,
    ...
    collection_master_edition_account: Option<trezoa_program::pubkey::Pubkey>,
    collection_authority_record: Option<trezoa_program::pubkey::Pubkey>,
    __remaining_accounts: Vec<trezoa_program::instruction::AccountMeta>,
}

itpl SetAndVerifySizedCollectionItemBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Metadata account
    ...
    pub fn collection_authority(
        &mut self,
        collection_authority: trezoa_program::pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn collection_mint(
        &mut self,
        collection_mint: trezoa_program::pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn collection_master_edition_account(
        &mut self,
        collection_master_edition_account: trezoa_program::pubkey::Pubkey,
    ) -> &mut Self {
...
pub struct SetAndVerifySizedCollectionItemCpiAccounts<'a, 'b> {
    ...
    /// Collection Update authority
    pub collection_authority: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// payer
    pub payer: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Update Authority of Collection NFT and NFT
    pub update_authority: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Mint of the Collection
    pub collection_mint: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Metadata Account of the Collection
    pub collection: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// MasterEdition2 Account of the Collection Token
    pub collection_master_edition_account: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Collection Authority Record PDA
    pub collection_authority_record: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
}
...
itpl<'a, 'b> SetAndVerifySizedCollectionItemCpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> SetAndVerifySizedCollectionItemCpiBuilder<'a, 'b> {
    ...
    pub fn collection_authority(
        &mut self,
        collection_authority: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn collection_mint(
        &mut self,
        collection_mint: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn collection_master_edition_account(
        &mut self,
        collection_master_edition_account: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn collection_authority_record(
        &mut self,
        collection_authority_record: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    ) -> &mut Self {
...
struct SetAndVerifySizedCollectionItemCpiBuilderInstruction<'a, 'b> {
    ...
    collection_authority: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    ...
    collection_master_edition_account: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    collection_authority_record: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
