...
pub struct MintNewEditionFromMasterEditionViaToken {
    ...
    pub token_account_owner: trezoa_program::pubkey::Pubkey,
...
itpl MintNewEditionFromMasterEditionViaToken {
    pub fn instruction(
        &self,
...
itpl MintNewEditionFromMasterEditionViaTokenInstructionData {
    pub fn new() -> Self {
...
pub struct MintNewEditionFromMasterEditionViaTokenBuilder {
    ...
    token_account_owner: Option<trezoa_program::pubkey::Pubkey>,
...
itpl MintNewEditionFromMasterEditionViaTokenBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// New Metadata key (pda of ['metadata', program id, mint id])
    ...
    pub fn token_account_owner(
        &mut self,
        token_account_owner: trezoa_program::pubkey::Pubkey,
    ) -> &mut Self {
...
pub struct MintNewEditionFromMasterEditionViaTokenCpiAccounts<'a, 'b> {
    ...
    /// owner of token account containing master token (#8)
    pub token_account_owner: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// token account containing token from master metadata mint
...
itpl<'a, 'b> MintNewEditionFromMasterEditionViaTokenCpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> MintNewEditionFromMasterEditionViaTokenCpiBuilder<'a, 'b> {
    ...
    pub fn token_account_owner(
        &mut self,
        token_account_owner: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct MintNewEditionFromMasterEditionViaTokenCpiBuilderInstruction<'a, 'b> {
    ...
    token_account_owner: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
