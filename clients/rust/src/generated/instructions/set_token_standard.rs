...
itpl SetTokenStandardInstructionData {
    pub fn new() -> Self {
...
itpl<'a, 'b> SetTokenStandardCpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> SetTokenStandardCpiBuilder<'a, 'b> {
