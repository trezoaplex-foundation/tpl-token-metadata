...
pub struct MintV1 {
    ...
    pub token_owner: Option<trezoa_program::pubkey::Pubkey>,
...
///   11. `[optional]` tpl_token_program (default to `TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA`)
...
pub struct MintV1CpiAccounts<'a, 'b> {
    ...
    /// Owner of the token account
    pub token_owner: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    /// Metadata account (pda of ['metadata', program id, mint id])
