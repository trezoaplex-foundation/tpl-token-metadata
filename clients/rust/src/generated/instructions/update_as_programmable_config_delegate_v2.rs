...
itpl UpdateAsProgrammableConfigDelegateV2 {
    pub fn instruction(
        &self,
...
itpl UpdateAsProgrammableConfigDelegateV2InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: 50,
...
itpl UpdateAsProgrammableConfigDelegateV2Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Update authority or delegate
...
itpl<'a, 'b> UpdateAsProgrammableConfigDelegateV2Cpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> UpdateAsProgrammableConfigDelegateV2CpiBuilder<'a, 'b> {
