...
itpl VerifyCollectionInstructionData {
    pub fn new() -> Self {
...
itpl<'a, 'b> VerifyCollectionCpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> VerifyCollectionCpiBuilder<'a, 'b> {
