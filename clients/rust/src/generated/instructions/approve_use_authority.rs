...
pub struct ApproveUseAuthority {
    ...
    pub burner: trezoa_program::pubkey::Pubkey,
    /// Token program
...
itpl ApproveUseAuthorityInstructionData {
    pub fn new() -> Self {
...
itpl ApproveUseAuthorityBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Use Authority Record PDA
    ...
    /// Program As Signer (Burner)
    #[inline(always)]
    pub fn burner(&mut self, burner: trezoa_program::pubkey::Pubkey) -> &mut Self {
...
pub struct ApproveUseAuthorityCpiAccounts<'a, 'b> {
    ...
    /// Program As Signer (Burner)
    pub burner: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Token program
...
itpl<'a, 'b> ApproveUseAuthorityCpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> ApproveUseAuthorityCpiBuilder<'a, 'b> {
    ...
    pub fn burner(
        &mut self,
        burner: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
