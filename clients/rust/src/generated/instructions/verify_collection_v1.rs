...
pub struct VerifyCollectionV1 {
    ...
    pub collection_master_edition: Option<trezoa_program::pubkey::Pubkey>,
    /// System program
...
itpl VerifyCollectionV1InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: 52,
...
pub struct VerifyCollectionV1Builder {
    ...
    collection_master_edition: Option<trezoa_program::pubkey::Pubkey>,
...
itpl VerifyCollectionV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Creator to verify, collection update authority or delegate
...
pub struct VerifyCollectionV1CpiAccounts<'a, 'b> {
    ...
    /// Master Edition Account of the Collection Token
    pub collection_master_edition: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    /// System program
...
itpl<'a, 'b> VerifyCollectionV1Cpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> VerifyCollectionV1CpiBuilder<'a, 'b> {
    ...
    pub fn collection_master_edition(
        &mut self,
        collection_master_edition: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    ) -> &mut Self {
