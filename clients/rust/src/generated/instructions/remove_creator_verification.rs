...
itpl RemoveCreatorVerification {
...
itpl RemoveCreatorVerificationInstructionData {
    pub fn new() -> Self {
...
itpl RemoveCreatorVerificationBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Metadata (pda of ['metadata', program id, mint id])
...
itpl<'a, 'b> RemoveCreatorVerificationCpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> RemoveCreatorVerificationCpiBuilder<'a, 'b> {
