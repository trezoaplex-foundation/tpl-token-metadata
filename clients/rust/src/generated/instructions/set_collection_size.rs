...
itpl SetCollectionSizeInstructionData {
    pub fn new() -> Self {
...
itpl<'a, 'b> SetCollectionSizeCpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> SetCollectionSizeCpiBuilder<'a, 'b> {
