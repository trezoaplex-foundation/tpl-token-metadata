...
itpl DelegateAuthorityItemV1InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: 44,
...
itpl DelegateAuthorityItemV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// `[optional account]`
...
itpl<'a, 'b> DelegateAuthorityItemV1Cpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> DelegateAuthorityItemV1CpiBuilder<'a, 'b> {
