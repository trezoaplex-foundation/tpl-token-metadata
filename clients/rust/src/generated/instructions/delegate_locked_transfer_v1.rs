...
itpl DelegateLockedTransferV1InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: 44,
...
itpl DelegateLockedTransferV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// `[optional account]`
...
itpl<'a, 'b> DelegateLockedTransferV1Cpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> DelegateLockedTransferV1CpiBuilder<'a, 'b> {
