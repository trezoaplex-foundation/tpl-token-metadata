...
itpl RevokeTransferV1InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: 45,
...
itpl<'a, 'b> RevokeTransferV1Cpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> RevokeTransferV1CpiBuilder<'a, 'b> {
