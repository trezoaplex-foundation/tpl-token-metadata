...
itpl RevokeStakingV1InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: 45,
...
itpl<'a, 'b> RevokeStakingV1Cpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> RevokeStakingV1CpiBuilder<'a, 'b> {
