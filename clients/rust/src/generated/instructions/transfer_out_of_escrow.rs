...
pub struct TransferOutOfEscrow {
    /// Escrow account
    pub escrow: trezoa_program::pubkey::Pubkey,
    /// Metadata account
    ...
    pub attribute_mint: trezoa_program::pubkey::Pubkey,
    /// Token account source for the new attribute
    pub attribute_src: trezoa_program::pubkey::Pubkey,
    /// Token account, owned by TM, destination for the new attribute
    pub attribute_dst: trezoa_program::pubkey::Pubkey,
    /// Mint account that the escrow is attached
    pub escrow_mint: trezoa_program::pubkey::Pubkey,
    /// Token account that holds the token the escrow is attached to
    pub escrow_account: trezoa_program::pubkey::Pubkey,
    /// System program
    pub system_program: trezoa_program::pubkey::Pubkey,
    /// Associated Token program
    pub ata_program: trezoa_program::pubkey::Pubkey,
    /// Token program
...
itpl TransferOutOfEscrowInstructionData {
    pub fn new() -> Self {
...
pub struct TransferOutOfEscrowBuilder {
    escrow: Option<trezoa_program::pubkey::Pubkey>,
    metadata: Option<trezoa_program::pubkey::Pubkey>,
    payer: Option<trezoa_program::pubkey::Pubkey>,
    attribute_mint: Option<trezoa_program::pubkey::Pubkey>,
    attribute_src: Option<trezoa_program::pubkey::Pubkey>,
    attribute_dst: Option<trezoa_program::pubkey::Pubkey>,
    escrow_mint: Option<trezoa_program::pubkey::Pubkey>,
    escrow_account: Option<trezoa_program::pubkey::Pubkey>,
    system_program: Option<trezoa_program::pubkey::Pubkey>,
    ata_program: Option<trezoa_program::pubkey::Pubkey>,
...
itpl TransferOutOfEscrowBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Escrow account
    #[inline(always)]
    pub fn escrow(&mut self, escrow: trezoa_program::pubkey::Pubkey) -> &mut Self {
    ...
    /// Mint account for the new attribute
    #[inline(always)]
    pub fn attribute_mint(&mut self, attribute_mint: trezoa_program::pubkey::Pubkey) -> &mut Self {
        self.attribute_mint = Some(attribute_mint);
        self
    }
    /// Token account source for the new attribute
    #[inline(always)]
    pub fn attribute_src(&mut self, attribute_src: trezoa_program::pubkey::Pubkey) -> &mut Self {
        self.attribute_src = Some(attribute_src);
        self
    }
    /// Token account, owned by TM, destination for the new attribute
    #[inline(always)]
    pub fn attribute_dst(&mut self, attribute_dst: trezoa_program::pubkey::Pubkey) -> &mut Self {
        self.attribute_dst = Some(attribute_dst);
        self
    }
    /// Mint account that the escrow is attached
    #[inline(always)]
    pub fn escrow_mint(&mut self, escrow_mint: trezoa_program::pubkey::Pubkey) -> &mut Self {
        self.escrow_mint = Some(escrow_mint);
        self
    }
    /// Token account that holds the token the escrow is attached to
    #[inline(always)]
    pub fn escrow_account(&mut self, escrow_account: trezoa_program::pubkey::Pubkey) -> &mut Self {
    ...
    /// Associated Token program
    #[inline(always)]
    pub fn ata_program(&mut self, ata_program: trezoa_program::pubkey::Pubkey) -> &mut Self {
    ...
    pub fn instruction(&self) -> trezoa_program::instruction::Instruction {
        let accounts = TransferOutOfEscrow {
            ...
            ata_program: self.ata_program.unwrap_or(trezoa_program::pubkey!(
...
pub struct TransferOutOfEscrowCpiAccounts<'a, 'b> {
    /// Escrow account
    pub escrow: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Metadata account
    pub metadata: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Wallet paying for the transaction and new account
    pub payer: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Mint account for the new attribute
    pub attribute_mint: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Token account source for the new attribute
    pub attribute_src: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Token account, owned by TM, destination for the new attribute
    pub attribute_dst: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Mint account that the escrow is attached
    pub escrow_mint: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Token account that holds the token the escrow is attached to
    pub escrow_account: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// System program
    pub system_program: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Associated Token program
    pub ata_program: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Token program
...
itpl<'a, 'b> TransferOutOfEscrowCpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> TransferOutOfEscrowCpiBuilder<'a, 'b> {
    ...
    pub fn escrow(
        &mut self,
        escrow: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn attribute_mint(
        &mut self,
        attribute_mint: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn attribute_src(
        &mut self,
        attribute_src: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn attribute_dst(
        &mut self,
        attribute_dst: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn escrow_mint(
        &mut self,
        escrow_mint: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn escrow_account(
        &mut self,
        escrow_account: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn ata_program(
        &mut self,
        ata_program: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct TransferOutOfEscrowCpiBuilderInstruction<'a, 'b> {
    ...
    escrow: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    metadata: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    payer: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    attribute_mint: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    attribute_src: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    attribute_dst: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    escrow_mint: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    escrow_account: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    system_program: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    ata_program: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
