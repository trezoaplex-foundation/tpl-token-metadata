...
itpl CreateMetadataAccountV3InstructionData {
    pub fn new() -> Self {
...
itpl CreateMetadataAccountV3Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Metadata key (pda of ['metadata', program id, mint id])
...
itpl<'a, 'b> CreateMetadataAccountV3Cpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> CreateMetadataAccountV3CpiBuilder<'a, 'b> {
