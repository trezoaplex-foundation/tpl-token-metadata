...
pub struct MintNewEditionFromMasterEditionViaVaultProxy {
    ...
    pub new_metadata: trezoa_program::pubkey::Pubkey,
    /// New Edition (pda of ['metadata', program id, mint id, 'edition'])
    pub new_edition: trezoa_program::pubkey::Pubkey,
    /// Master Record Edition V2 (pda of ['metadata', program id, master metadata mint id, 'edition']
    pub master_edition: trezoa_program::pubkey::Pubkey,
    /// Mint of new token - THIS WILL TRANSFER AUTHORITY AWAY FROM THIS KEY
    pub new_mint: trezoa_program::pubkey::Pubkey,
    /// Edition pda to mark creation - will be checked for pre-existence. (pda of ['metadata', program id, master metadata mint id, 'edition', edition_number]) where edition_number is NOT the edition number you pass in args but actually edition_number = floor(edition/EDITION_MARKER_BIT_SIZE).
    pub edition_mark_pda: trezoa_program::pubkey::Pubkey,
    /// Mint authority of new mint
    pub new_mint_authority: trezoa_program::pubkey::Pubkey,
    /// payer
    pub payer: trezoa_program::pubkey::Pubkey,
    /// Vault authority
    pub vault_authority: trezoa_program::pubkey::Pubkey,
    /// Safety deposit token store account
    pub safety_deposit_store: trezoa_program::pubkey::Pubkey,
    /// Safety deposit box
    pub safety_deposit_box: trezoa_program::pubkey::Pubkey,
    /// Vault
    pub vault: trezoa_program::pubkey::Pubkey,
    /// Update authority info for new metadata
    pub new_metadata_update_authority: trezoa_program::pubkey::Pubkey,
    /// Master record metadata account
    pub metadata: trezoa_program::pubkey::Pubkey,
    /// Token program
    pub token_program: trezoa_program::pubkey::Pubkey,
    /// Token vault program
    pub token_vault_program: trezoa_program::pubkey::Pubkey,
    /// System program
...
itpl MintNewEditionFromMasterEditionViaVaultProxy {
    pub fn instruction(
        &self,
...
itpl MintNewEditionFromMasterEditionViaVaultProxyInstructionData {
    pub fn new() -> Self {
...
pub struct MintNewEditionFromMasterEditionViaVaultProxyBuilder {
    new_metadata: Option<trezoa_program::pubkey::Pubkey>,
    new_edition: Option<trezoa_program::pubkey::Pubkey>,
    master_edition: Option<trezoa_program::pubkey::Pubkey>,
    new_mint: Option<trezoa_program::pubkey::Pubkey>,
    edition_mark_pda: Option<trezoa_program::pubkey::Pubkey>,
    new_mint_authority: Option<trezoa_program::pubkey::Pubkey>,
    payer: Option<trezoa_program::pubkey::Pubkey>,
    vault_authority: Option<trezoa_program::pubkey::Pubkey>,
    safety_deposit_store: Option<trezoa_program::pubkey::Pubkey>,
    safety_deposit_box: Option<trezoa_program::pubkey::Pubkey>,
    vault: Option<trezoa_program::pubkey::Pubkey>,
    new_metadata_update_authority: Option<trezoa_program::pubkey::Pubkey>,
    metadata: Option<trezoa_program::pubkey::Pubkey>,
    token_program: Option<trezoa_program::pubkey::Pubkey>,
    token_vault_program: Option<trezoa_program::pubkey::Pubkey>,
...
itpl MintNewEditionFromMasterEditionViaVaultProxyBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// New Metadata key (pda of ['metadata', program id, mint id])
    #[inline(always)]
    pub fn new_metadata(&mut self, new_metadata: trezoa_program::pubkey::Pubkey) -> &mut Self {
        self.new_metadata = Some(new_metadata);
        self
    }
    /// New Edition (pda of ['metadata', program id, mint id, 'edition'])
    #[inline(always)]
    pub fn new_edition(&mut self, new_edition: trezoa_program::pubkey::Pubkey) -> &mut Self {
    ...
    /// Mint of new token - THIS WILL TRANSFER AUTHORITY AWAY FROM THIS KEY
    #[inline(always)]
    pub fn new_mint(&mut self, new_mint: trezoa_program::pubkey::Pubkey) -> &mut Self {
    ...
    pub fn edition_mark_pda(
        &mut self,
        edition_mark_pda: trezoa_program::pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn new_mint_authority(
        &mut self,
        new_mint_authority: trezoa_program::pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn vault_authority(
        &mut self,
        vault_authority: trezoa_program::pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn safety_deposit_store(
        &mut self,
        safety_deposit_store: trezoa_program::pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn safety_deposit_box(
        &mut self,
        safety_deposit_box: trezoa_program::pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn new_metadata_update_authority(
        &mut self,
        new_metadata_update_authority: trezoa_program::pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn token_vault_program(
        &mut self,
        token_vault_program: trezoa_program::pubkey::Pubkey,
    ) -> &mut Self {
...
pub struct MintNewEditionFromMasterEditionViaVaultProxyCpiAccounts<'a, 'b> {
    /// New Metadata key (pda of ['metadata', program id, mint id])
    pub new_metadata: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// New Edition (pda of ['metadata', program id, mint id, 'edition'])
    pub new_edition: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Master Record Edition V2 (pda of ['metadata', program id, master metadata mint id, 'edition']
    pub master_edition: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Mint of new token - THIS WILL TRANSFER AUTHORITY AWAY FROM THIS KEY
    pub new_mint: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Edition pda to mark creation - will be checked for pre-existence. (pda of ['metadata', program id, master metadata mint id, 'edition', edition_number]) where edition_number is NOT the edition number you pass in args but actually edition_number = floor(edition/EDITION_MARKER_BIT_SIZE).
    pub edition_mark_pda: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Mint authority of new mint
    pub new_mint_authority: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// payer
    pub payer: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Vault authority
    pub vault_authority: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Safety deposit token store account
    pub safety_deposit_store: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Safety deposit box
    pub safety_deposit_box: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Vault
    pub vault: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Update authority info for new metadata
    pub new_metadata_update_authority: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Master record metadata account
    pub metadata: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Token program
    pub token_program: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Token vault program
    pub token_vault_program: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// System program
...
itpl<'a, 'b> MintNewEditionFromMasterEditionViaVaultProxyCpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> MintNewEditionFromMasterEditionViaVaultProxyCpiBuilder<'a, 'b> {
    ...
    pub fn new_metadata(
        &mut self,
        new_metadata: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn new_edition(
        &mut self,
        new_edition: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn new_mint(
        &mut self,
        new_mint: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn edition_mark_pda(
        &mut self,
        edition_mark_pda: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn new_mint_authority(
        &mut self,
        new_mint_authority: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn vault_authority(
        &mut self,
        vault_authority: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn safety_deposit_store(
        &mut self,
        safety_deposit_store: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn safety_deposit_box(
        &mut self,
        safety_deposit_box: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn new_metadata_update_authority(
        &mut self,
        new_metadata_update_authority: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn token_vault_program(
        &mut self,
        token_vault_program: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct MintNewEditionFromMasterEditionViaVaultProxyCpiBuilderInstruction<'a, 'b> {
    ...
    new_metadata: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    new_edition: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    master_edition: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    new_mint: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    edition_mark_pda: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    new_mint_authority: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    payer: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    vault_authority: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    safety_deposit_store: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    safety_deposit_box: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    vault: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    new_metadata_update_authority: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    ...
    token_vault_program: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
