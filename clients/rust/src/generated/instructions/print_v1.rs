...
pub struct PrintV1 {
    ...
    pub master_token_account_owner: trezoa_program::pubkey::Pubkey,
...
pub struct PrintV1Builder {
    ...
    master_token_account_owner: Option<trezoa_program::pubkey::Pubkey>,
...
pub struct PrintV1CpiAccounts<'a, 'b> {
    ...
    /// owner of token account containing master token
    pub master_token_account_owner: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// token account containing token from master metadata mint
...
itpl<'a, 'b> PrintV1CpiBuilder<'a, 'b> {
...
struct PrintV1CpiBuilderInstruction<'a, 'b> {
    ...
    master_token_account_owner: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
