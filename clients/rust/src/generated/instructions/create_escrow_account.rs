...
itpl CreateEscrowAccountInstructionData {
    pub fn new() -> Self {
...
itpl CreateEscrowAccountBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Escrow account
...
itpl<'a, 'b> CreateEscrowAccountCpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> CreateEscrowAccountCpiBuilder<'a, 'b> {
