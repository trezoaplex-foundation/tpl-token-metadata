...
itpl VerifyCreatorV1InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: 52,
...
itpl<'a, 'b> VerifyCreatorV1Cpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> VerifyCreatorV1CpiBuilder<'a, 'b> {
