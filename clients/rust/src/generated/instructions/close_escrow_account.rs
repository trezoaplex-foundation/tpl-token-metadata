...
itpl CloseEscrowAccountInstructionData {
    pub fn new() -> Self {
...
itpl CloseEscrowAccountBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Escrow account
...
itpl<'a, 'b> CloseEscrowAccountCpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> CloseEscrowAccountCpiBuilder<'a, 'b> {
