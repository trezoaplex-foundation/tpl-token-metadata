...
itpl FreezeDelegatedAccountInstructionData {
    pub fn new() -> Self {
...
itpl FreezeDelegatedAccountBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Delegate
...
itpl<'a, 'b> FreezeDelegatedAccountCpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> FreezeDelegatedAccountCpiBuilder<'a, 'b> {
