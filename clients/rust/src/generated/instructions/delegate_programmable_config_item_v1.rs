...
itpl DelegateProgrammableConfigItemV1 {
    pub fn instruction(
        &self,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        if let Some(token) = self.token {
            accounts.push(trezoa_program::instruction::AccountMeta::new(token, false));
        } else {
            accounts.push(trezoa_program::instruction::AccountMeta::new_readonly(
                crate::TPL_TOKEN_METADATA_ID,
                false,
...
itpl DelegateProgrammableConfigItemV1InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: 44,
...
itpl DelegateProgrammableConfigItemV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// `[optional account]`
...
itpl<'a, 'b> DelegateProgrammableConfigItemV1Cpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> DelegateProgrammableConfigItemV1CpiBuilder<'a, 'b> {
