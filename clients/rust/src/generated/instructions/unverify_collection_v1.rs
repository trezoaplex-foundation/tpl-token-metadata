...
itpl UnverifyCollectionV1InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: 53,
...
itpl UnverifyCollectionV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Creator to verify, collection (or metadata if parent burned) update authority or delegate
...
itpl<'a, 'b> UnverifyCollectionV1Cpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> UnverifyCollectionV1CpiBuilder<'a, 'b> {
