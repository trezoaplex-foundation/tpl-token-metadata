...
itpl CreateMasterEditionV3InstructionData {
    pub fn new() -> Self {
...
itpl CreateMasterEditionV3Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Unallocated edition V2 account with address as pda of ['metadata', program id, mint, 'edition']
...
itpl<'a, 'b> CreateMasterEditionV3Cpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> CreateMasterEditionV3CpiBuilder<'a, 'b> {
