...
itpl RevokeCollectionItemV1InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: 45,
...
itpl RevokeCollectionItemV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// `[optional account]`
...
itpl<'a, 'b> RevokeCollectionItemV1Cpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> RevokeCollectionItemV1CpiBuilder<'a, 'b> {
