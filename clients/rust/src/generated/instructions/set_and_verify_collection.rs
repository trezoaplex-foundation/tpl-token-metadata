...
itpl SetAndVerifyCollectionInstructionData {
    pub fn new() -> Self {
...
itpl SetAndVerifyCollectionBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Metadata account
...
itpl<'a, 'b> SetAndVerifyCollectionCpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> SetAndVerifyCollectionCpiBuilder<'a, 'b> {
