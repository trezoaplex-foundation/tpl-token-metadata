...
pub struct Utilize {
    ...
    pub use_authority: trezoa_program::pubkey::Pubkey,
    /// Owner
    ...
    pub use_authority_record: Option<trezoa_program::pubkey::Pubkey>,
    /// Program As Signer (Burner)
    pub burner: Option<trezoa_program::pubkey::Pubkey>,
}
...
pub struct UtilizeBuilder {
    ...
    use_authority: Option<trezoa_program::pubkey::Pubkey>,
    ...
    burner: Option<trezoa_program::pubkey::Pubkey>,
...
itpl UtilizeBuilder {
    ...
    /// A Use Authority / Can be the current Owner of the NFT
    #[inline(always)]
    pub fn use_authority(&mut self, use_authority: trezoa_program::pubkey::Pubkey) -> &mut Self {
    ...
    /// Program As Signer (Burner)
    #[inline(always)]
    pub fn burner(&mut self, burner: Option<trezoa_program::pubkey::Pubkey>) -> &mut Self {
        self.burner = burner;
        self
    }
    #[inline(always)]
...
pub struct UtilizeCpiAccounts<'a, 'b> {
    ...
    /// A Use Authority / Can be the current Owner of the NFT
    pub use_authority: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// Owner
    ...
    /// Use Authority Record PDA If present the program Assumes a delegated use authority
    pub use_authority_record: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    /// Program As Signer (Burner)
    pub burner: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
}
...
itpl<'a, 'b> UtilizeCpiBuilder<'a, 'b> {
    ...
    pub fn use_authority(
        &mut self,
        use_authority: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn burner(
        &mut self,
        burner: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    ) -> &mut Self {
...
struct UtilizeCpiBuilderInstruction<'a, 'b> {
    ...
    use_authority: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
