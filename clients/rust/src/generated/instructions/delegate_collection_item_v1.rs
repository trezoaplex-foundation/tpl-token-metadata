...
itpl DelegateCollectionItemV1InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: 44,
...
itpl DelegateCollectionItemV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// `[optional account]`
...
itpl<'a, 'b> DelegateCollectionItemV1Cpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> DelegateCollectionItemV1CpiBuilder<'a, 'b> {
