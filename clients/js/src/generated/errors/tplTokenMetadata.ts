...
export class ReservationNotCotpleteError extends ProgramError {
  override readonly name: string = 'ReservationNotCotplete';
...
codeToErrorMap.set(0x41, ReservationNotCotpleteError);
nameToErrorMap.set('ReservationNotCotplete', ReservationNotCotpleteError);
...
export class MissingSplTokenProgramError extends ProgramError {
  ...
  constructor(program: Program, cause?: Error) {
    super('Missing TPL token program', program, cause);
  }
}
