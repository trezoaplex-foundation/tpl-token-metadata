...
export type PrintV1Instruction<
  TProgram extends string = typeof TPL_TOKEN_METADATA_PROGRAM_ADDRESS,
...
export async function getPrintV1InstructionAsync<
  ...
  TAccountSysvarInstructions extends string,
  TAccountSystemProgram extends string,
  TProgramAddress extends Address = typeof TPL_TOKEN_METADATA_PROGRAM_ADDRESS,
>(
...
> {
  ...
  const programAddress =
    config?.programAddress ?? TPL_TOKEN_METADATA_PROGRAM_ADDRESS;
...
>(
  ...
  const getNextOptionalAccount = () => {
    ...
    return accountMeta.address === TPL_TOKEN_METADATA_PROGRAM_ADDRESS
      ? undefined
      : accountMeta;
  };
  return {
