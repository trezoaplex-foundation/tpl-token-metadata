...
export const TPL_TOKEN_METADATA_PROGRAM_ADDRESS =
...
export function identifyMplTokenMetadataAccount(
  ...
  throw new Error(
    'The provided account could not be identified as a tplTokenMetadata account.'
  );
}
...
export function identifyMplTokenMetadataInstruction(
  ...
  throw new Error(
    'The provided instruction could not be identified as a tplTokenMetadata instruction.'
  );
}
